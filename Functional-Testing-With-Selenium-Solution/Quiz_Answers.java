...
public class Quiz_2 {
	...
	//cancelButton = driver.findElement(By.cssSelector("//g-raised-button[@jsaction=\'dArJMd\']")); - wrong
	driver.findElement(By.cssSelector("g-raised-button[jsaction=\'dArJMd\']"));
	
	//What is your line of code for #12?
	driver.findElement(By.cssSelector("g-raised-button[jsaction=\'dArJMd\']")); 
	
	//What is your line of code for #13?
	driver.findElement(By.cssSelector("g-raised-button[jsaction=\'iyDKIb\']"));
	...
	//driver.findElement(By.cssSelector("div.pPHzQc]")).click(); - wrong
	driver.findElement(By.cssSelector("div[jsname=\'pPHzQc\']")).click();
	
	//What is your line of code for #33?
	//driver.findElement(By.cssSelector("div.lVjWed")).click(); - wrong
